...
if __name__ == "__main__":
    ...
    if valA == "ortho" or valA == "ident" or valA == "ortho_haar":
        valC = "_ident_C"
    ...
    config.override("num_traces", {"train": 1, "val": 10000}) #number of validation traces per system
    ...
    filename = path + f"check_interleaved_traces_{valA}{valC}_state_dim_{nx}_num_sys_haystack_{num_sys_haystack}.pkl"
