...
class Config(object, metaclass=Singleton):
    ...
    batch_size =  480 #1024 #512 #8*40 #usually 512 (~35GB) tune this to fit into GPU memory
    acc_grad_batch = 1 #number of batches to accumulate gradients over
    train_data_workers = 4 #set to 1 (check if it changes the speed of the training process)
    test_batch_size = 512
