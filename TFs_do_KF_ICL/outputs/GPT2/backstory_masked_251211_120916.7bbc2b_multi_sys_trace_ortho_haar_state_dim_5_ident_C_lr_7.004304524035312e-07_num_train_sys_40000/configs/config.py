...
class Config(object, metaclass=Singleton):
    ...
    batch_size =  1 #1024 #512 #8*40 #usually 512 (~35GB) tune this to fit into GPU memory
    acc_grad_batch = 1 #number of batches to accumulate gradients over
    train_data_workers = 71 #set to 1 (check if it changes the speed of the training process)
    test_batch_size = 512
    ...
    learning_rate = np.sqrt((len(devices) * batch_size)/512)*1.584893192461114e-05 #1.9054607179632464e-05. #(0.833333333)
    weight_decay = 1e-2
